...
# # i.21.3.12.7:50)
# image_file = r"someRootDirJ\leftImg8bit\val\frankfurt\frankfurt_000000_000294_leftImg8bit.png"

# sem_label_file = (
#     image_file.replace("leftImg8bit", "gtFine").split(".")[0] + "_labelTrainIds.png"  
# )

# print(f'j) sem_label_file: {sem_label_file}')
...
import os
# image_file = r"someRootDirJ\leftImg8bit\val\frankfurt\frankfurt_000000_000294_leftImg8bit.png"
# print(f'j) basename: {os.path.basename(image_file)}') # frankfurt_000000_000294_leftImg8bit.png
# print(f'j) splited: {os.path.splitext(image_file)}') # ('someRootDirJ\\leftImg8bit\\val\\frankfurt\\frankfurt_000000_000294_leftImg8bit', '.png')  

image_dir = r"C:\Users\starriet\Downloads\panopticSeg_dentPanoJ\inputOriPano\train"
print(f'j) os.listdir(image_dir): {os.listdir(image_dir)}')
print(f'j) num files: {len(os.listdir(image_dir))}')

print(os.path.splitext(os.listdir(image_dir)[0])[0])
